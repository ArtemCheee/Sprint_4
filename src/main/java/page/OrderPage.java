...
public class OrderPage {
    ...
    private final  By newOrderHeader = By.xpath(".//div[starts-with(@class, 'Order_Header_')]");
    ...
    //Метод для ракрытия списка срока аренды
    ...
    public String getOrderHeaderText() {
        return this.webDriver.findElement(this.newOrderHeader).getText();
    }
